...
static int acceptOrDie(uint16_t port)
{
  ...
  // muduo ���ｫ listen �ĵڶ�������backlog ��Ϊ 5
  // ÿһ����������Ҫ����һ������������У��ȴ� listen �ĳ������ accept()��accept()���������н��ܣ�����������������ӡ�
  // ��ϵͳ��û�� ���� accept()������ʱ������кܶ����ӣ���ô�����ܹ��ȴ��������Ŀ���� backlog �� ��ֵ��
...
static int write_n(int sockfd, const void* buf, int length)
{
  ...
  while (written < length)
  {
    ...
    {
      break;  // 之前写错了， nw = 0 时候 ，读取结束。
    } 
    else if (errno != EINTR) // 此时默认进行处理， 若非中断错误，则结束，报告错误。
    {
      perror("write");
      break;
    }
